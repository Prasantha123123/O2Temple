...
function DialogContent({
  ...
  return (
    <DialogPortal data-slot="dialog-portal">
      ...
      >
        {children}
        <DialogPrimitive.Close className="ring-offset-white focus:ring-teal-500 absolute top-4 right-4 rounded-full p-1 text-gray-400 opacity-70 transition-all hover:opacity-100 hover:bg-gray-100 hover:text-gray-600 focus:ring-2 focus:ring-offset-2 focus:outline-hidden disabled:pointer-events-none [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4">
          <XIcon />
